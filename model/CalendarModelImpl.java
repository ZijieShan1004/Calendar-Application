 ...
 * Handles creation, modification, deletion, and querying of calendar events.
 */
public class CalendarModelImpl implements CalendarModel {
  ...
  /**
   * A constructor that initializes the String formats for all times and dates
   * and the hashmap and Id's for the events and series.
   */
  ...
  public int createTimedEventSeries(String subject, String description, String startDate,
    ...
    List<Event> seriesEvents = generateSeriesEvents(subject, description, location, status,
            firstStart, firstEnd, targetDays,
            recurrence, until);
  ...
  private List<Event> generateSeriesEvents(
          String subject, String description, String location,
          Status status, LocalDateTime firstStart, LocalDateTime firstEnd,
          List<DayOfWeek> targetDays, int recurrence, LocalDate until) {
    ...
    while (dayCount < 10000) {  // Safety limit
  ...
  private List<Event> generateAllDaySeriesEvents(
          String subject, String description, String location,
          Status status, LocalDate startDate, List<DayOfWeek> targetDays,
